export default function BookingSummary({ validation, onProceed, loading, apiError, onRetry }) {
  const { isValid, totalBeds, totalGuests, totalPrice, nights, errors } = validation;
